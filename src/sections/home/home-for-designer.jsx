    ...
    const borderTop = (
        <AnimateBorder
            animate={{
                ...
                outline: `135deg, ${varAlpha(theme.vars.palette.primary.mainChannel, 0.08)}, ${varAlpha(
            ...
            sx={{
                ...
                background: `linear-gradient(135deg, ${varAlpha(theme.vars.palette.grey['900Channel'], 0.8)} 0%, ${
    ...
    const borderBottom = (
        <AnimateBorder
            animate={{
                ...
                outline: `135deg, ${varAlpha(theme.vars.palette.common.whiteChannel, 0.08)}, ${varAlpha(
    ...
    return (
        <Stack
            ...
            sx={{
                ...
                minHeight: { md: 720 },
                backgroundImage: {
                    xs: `linear-gradient(135deg, ${varAlpha(theme.vars.palette.grey['900Channel'], 0.8)} 0%, ${
                        theme.vars.palette.grey[900]
                    } 75%), url(${CONFIG.site.basePath}/assets/images/home/for-designer.webp)`,
                    ...
                    >
                        <AnimateBorder
                            animate={{
                                ...
                                outline: `135deg, ${varAlpha(theme.vars.palette.primary.mainChannel, 0.04)}, ${varAlpha(
                                    theme.vars.palette.primary.mainChannel,
                                    0.04,
                                )}`,
                            }}
