...
export function ScrollProgressView() {
    ...
    return (
        <>
            ...
            <ComponentContainer>
                <ComponentBlock title="Container scroll Y" sx={{ flexDirection: 'column', alignItems: 'unset' }}>
                    <ScrollProgress
                        color="info"
                        variant="circular"
                        size={40}
                    ...
                    <ScrollProgress variant="linear" color="info" progress={containerProgress1.scrollYProgress} />
                ...
                <ComponentBlock title="Container scroll X" sx={{ flexDirection: 'column', alignItems: 'unset' }}>
                    <ScrollProgress
                        color="inherit"
                        variant="circular"
                        size={40}
                    ...
                    <ScrollProgress variant="linear" color="inherit" progress={containerProgress2.scrollXProgress} />
