        ...
        <Card>
            ...
            <Stack spacing={3} sx={{ p: 3 }}>
                ...
                >
                    ...
                    <Field.MultiSelect checkbox name="colors" label="Colors" options={PRODUCT_COLOR_NAME_OPTIONS} />
    ...
    const renderPricing = (
        <Card>
            ...
            <Stack spacing={3} sx={{ p: 3 }}>
                ...
                <FormControlLabel
                    control={<Switch id="toggle-taxes" checked={includeTaxes} onChange={handleChangeIncludeTaxes} />}
