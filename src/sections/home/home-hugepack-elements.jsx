        ...
        <Stack component="section" sx={{ pt: 10, position: 'relative', ...sx }} {...other}>
            <MotionViewport>
                ...
                <Container sx={{ textAlign: { xs: 'center', md: 'left' } }}>
                    <Grid container disableEqualOverflow rowSpacing={{ xs: 3, md: 0 }} columnSpacing={{ xs: 0, md: 8 }}>
...
const StyledRoot = styled(forwardRef((props, ref) => <Box ref={ref} component={m.div} {...props} />))(({ theme }) => ({
    zIndex: 9,
    position: 'relative',
