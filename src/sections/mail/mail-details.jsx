...
export function MailDetails({ mail, renderLabel, empty, loading }) {
    ...
    const renderContent = <Markdown content={mail.message} sx={{ px: 2, '& p': { typography: 'body2' } }} />;
    ...
    const renderEditor = (
        <>
            ...
            <Stack direction="row" alignItems="center">
                ...
                <Button color="primary" variant="contained" endIcon={<Iconify icon="iconamoon:send-fill" />}>
                    Send
                </Button>
            </Stack>
        </>
