        ...
        >
            ...
            <Box
                ...
                sx={{
                    ...
                    backgroundImage: `linear-gradient(180deg, ${theme.vars.palette.background.default} 12%, ${varAlpha(
                        theme.vars.palette.background.defaultChannel,
                        0.92,
                    )} 50%, ${theme.vars.palette.background.default} 88%), url('${
                    ...
                    [stylesMode.dark]: {
                        ...
                        } 12%, ${varAlpha(theme.vars.palette.background.defaultChannel, 0.96)} 50%, ${
                            theme.vars.palette.background.default
                        } 88%), url('${CONFIG.site.basePath}/assets/background/background-3.webp')`,
                    },
                }}
            />
        </Stack>
