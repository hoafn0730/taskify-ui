        ...
        <Container component={MotionViewport} sx={{ py: { xs: 10, md: 15 }, textAlign: { xs: 'center', md: 'unset' } }}>
            <Grid container columnSpacing={{ md: 3 }} alignItems="flex-start">
                ...
                <Grid xs={12} md={6} lg={5}>
                    ...
                    <m.div variants={varFade().inRight}>
                        <Typography sx={{ color: 'text.secondary', [stylesMode.dark]: { color: 'common.white' } }}>
                            ...
                            import in one click and everything from the theme options to page content can be edited from
