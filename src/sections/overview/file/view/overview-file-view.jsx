            ...
            data={[
                {
                    ...
                    usedStorage: GB / 2,
                    filesCount: 223,
                    icon: <Box component="img" src={`${CONFIG.site.basePath}/assets/icons/files/ic-img.svg`} />,
                },
                {
                    name: 'Media',
                    usedStorage: GB / 5,
                    filesCount: 223,
                    icon: <Box component="img" src={`${CONFIG.site.basePath}/assets/icons/files/ic-video.svg`} />,
                },
                {
                    name: 'Documents',
                    usedStorage: GB / 5,
                    filesCount: 223,
                    icon: <Box component="img" src={`${CONFIG.site.basePath}/assets/icons/files/ic-document.svg`} />,
                },
                {
                    name: 'Other',
                    usedStorage: GB / 10,
                    filesCount: 223,
                    icon: <Box component="img" src={`${CONFIG.site.basePath}/assets/icons/files/ic-file.svg`} />,
                },
            ]}
        />
    );
