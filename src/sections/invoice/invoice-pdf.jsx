    ...
    const renderInfo = (
        <View style={[styles.container, styles.mb40]}>
            <View style={{ width: '50%' }}>
                ...
                <Text style={styles.body2}>{'Taskify'}</Text>
            ...
            <View style={{ width: '50%' }}>
                ...
                <Text style={styles.body2}>{'Hoàn Trần'}</Text>
        ...
        <>
            ...
            <View style={styles.table}>
                ...
                <View>
                    ...
                    {[
                        { name: 'Subtotal', value: amount },
                        { name: 'Total', value: amount, styles: styles.h4 },
                    ].map((item) => (
