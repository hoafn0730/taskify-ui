    ...
    },
    {
        ...
        answer: (
            <Box component="ul" sx={{ pl: 3, listStyleType: 'disc' }}>
                ...
                <li>
                    <strong>Extended</strong> license used in charge products, collect fees from users (SAAS...).
                </li>
                <li>
    ...
    },
    {
        ...
        answer: (
            <Typography>
                ...
                An example could be the back-office dashboard of a public-facing e-commerce website in which staff would
    ...
    },
    {
        ...
        answer: (
            <Typography>
                ...
                dashboard template which should give you an overview of the code quality and folder structure. Keep in
                mind that some aspects may differ from this Paid version.
            </Typography>
        ),
    },
];
...
export function HomeFAQs({ sx, ...other }) {
    ...
    const renderDescription = (
        <SectionTitle
            caption={t('faqs.sectionTitle.subtitle')}
            title={t('faqs.sectionTitle.title')}
            txtGradient={t('faqs.sectionTitle.titleSuffix')}
            sx={{ textAlign: 'center' }}
        />
    );
    ...
    const renderContact = (
        <Stack
            ...
            sx={{
                ...
                textAlign: 'center',
                background: (theme) =>
                    `linear-gradient(270deg, ${varAlpha(theme.vars.palette.grey['500Channel'], 0.08)}, ${varAlpha(
        ...
        >
            ...
            <m.div variants={varFade().in}>
                <Typography sx={{ mt: 2, mb: 3, color: 'text.secondary' }}>{t('contact.description')}</Typography>
            </m.div>
